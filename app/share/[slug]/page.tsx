  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Shark Puddle business idea pitch platform (demo app for LLMAsAService.io)"
        />
        <meta
          property="og:title"
          content="Shark Puddle business idea pitch platform "
        />
        <meta
        ...
        <meta
          property="og:url"
          content={"//shark-puddle.com/share/" + idea?.id}
        />
        <meta
          property="og:image"
